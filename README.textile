...
Preferences:
{:git=>true, :apps4=>"rails-devise", :unit_test=>false, :integration=>false, :fixtures=>false, :authentication=>"devise", :authorization=>false, :starter_app=>false, :quiet_assets=>true, :local_env_file=>true, :better_errors=>true, :dev_webserver=>"webrick", :prod_webserver=>"same", :database=>"mongodb", :orm=>"mongoid", :templates=>"erb", :continuous_testing=>"none", :frontend=>"bootstrap3", :email=>"gmail", :devise_modules=>"default", :form_builder=>"simple_form", :rvmrc=>true, :ban_spiders=>true, :github=>true}
